...
void getSupermers_GPU (string seq, int klen, int mlen, int nproc,
			   ...
			   int BUFF_LEN,
			   int minimizer_ordering, uhs_hashtable_slot* uhs_frequencies_hashtable, uint64_t uhs_hashtable_capacity, float uhs_sample_fraction,
			   uhs_key_t* uhs_mmers, uint64_t uhs_mmers_count, long uhs_mpi_mode);
